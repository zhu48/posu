...
TEMPLATE_TEST_CASE(
    ...
    (std::tuple<
        ...
        posu::units::si::basic_second<int, posu::ratio<1, 3>>,
        posu::units::si::basic_second<int, posu::ratio<1, 5>>,
        posu::units::si::basic_second<double, posu::ratio<1>>,
        posu::units::si::candelas>),
    (std::tuple<
        posu::units::si::kilometers,
        posu::units::si::meters,
        posu::units::si::basic_meter<int, posu::ratio<1, 3>>,
        posu::units::si::basic_meter<int, posu::ratio<1, 5>>,
        posu::units::si::basic_meter<double, posu::ratio<1>>,
        posu::units::si::seconds>),
    (std::tuple<
        posu::units::si::kilograms,
        posu::units::si::grams,
        posu::units::si::basic_gram<int, posu::ratio<1, 3>>,
        posu::units::si::basic_gram<int, posu::ratio<1, 5>>,
        posu::units::si::basic_gram<double, posu::ratio<1>>,
        posu::units::si::meters>),
    (std::tuple<
        posu::units::si::kiloamperes,
        posu::units::si::amperes,
        posu::units::si::basic_ampere<int, posu::ratio<1, 3>>,
        posu::units::si::basic_ampere<int, posu::ratio<1, 5>>,
        posu::units::si::basic_ampere<double, posu::ratio<1>>,
        posu::units::si::grams>),
    (std::tuple<
        posu::units::si::kilokelvins,
        posu::units::si::kelvins,
        posu::units::si::basic_kelvin<int, posu::ratio<1, 3>>,
        posu::units::si::basic_kelvin<int, posu::ratio<1, 5>>,
        posu::units::si::basic_kelvin<double, posu::ratio<1>>,
        posu::units::si::amperes>),
    (std::tuple<
        posu::units::si::kilomoles,
        posu::units::si::moles,
        posu::units::si::basic_mole<int, posu::ratio<1, 3>>,
        posu::units::si::basic_mole<int, posu::ratio<1, 5>>,
        posu::units::si::basic_mole<double, posu::ratio<1>>,
        posu::units::si::kelvins>),
    (std::tuple<
        posu::units::si::kilocandelas,
        posu::units::si::candelas,
        posu::units::si::basic_candela<int, posu::ratio<1, 3>>,
        posu::units::si::basic_candela<int, posu::ratio<1, 5>>,
        posu::units::si::basic_candela<double, posu::ratio<1>>,
        posu::units::si::moles>))
{
