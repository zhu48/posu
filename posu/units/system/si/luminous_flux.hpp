...
namespace posu::units::si {
    ...
    using attolumens  = basic_lumen<int, std::atto>;
    using femtolumens = basic_lumen<int, std::femto>;
    using picolumens  = basic_lumen<int, std::pico>;
    using nanolumens  = basic_lumen<int, std::nano>;
    using microlumens = basic_lumen<int, std::micro>;
    using millilumens = basic_lumen<int, std::milli>;
    using centilumens = basic_lumen<int, std::centi>;
    using decilumens  = basic_lumen<int, std::deci>;
    using lumens      = basic_lumen<int, std::ratio<1>>;
    using decalumens  = basic_lumen<int, std::deca>;
    using hectolumens = basic_lumen<int, std::hecto>;
    using kilolumens  = basic_lumen<int, std::kilo>;
    using megalumens  = basic_lumen<int, std::mega>;
    using gigalumens  = basic_lumen<int, std::giga>;
    using teralumens  = basic_lumen<int, std::tera>;
    using petalumens  = basic_lumen<int, std::peta>;
    using exalumens   = basic_lumen<int, std::exa>;
